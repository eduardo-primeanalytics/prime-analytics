...
- [ ] **Consider shortening "Book a call" from 30 to 20 minutes.** Direct competitor (Data Solutions Agency) uses 20 min; lower-commitment ask for cold traffic with no case studies yet. Optional, not a correctness issue.
